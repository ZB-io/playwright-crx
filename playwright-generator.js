"use strict";
(() => {
  // playwright/packages/playwright-core/src/utils/isomorphic/ariaSnapshot.ts
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/cssTokenizer.ts
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/cssParser.ts
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/selectorParser.ts
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/stringUtils.ts
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/locatorGenerators.ts
  ...
  // playwright/packages/injected/src/domUtils.ts
  var globalOptions = {};
  ...
  // playwright/packages/injected/src/yaml.ts
  ...
  // playwright/packages/injected/src/ariaSnapshot.ts
  var lastRef = 0;
  ...
  // playwright/packages/injected/src/highlight.css?inline
  var highlight_default = {};

  // playwright/packages/injected/src/highlight.ts
  var Highlight = class {
  ...
  // playwright/packages/injected/src/layoutSelectorUtils.ts
  ...
  // playwright/packages/injected/src/selectorUtils.ts
  ...
  // playwright/packages/injected/src/reactSelectorEngine.ts
  ...
  function getChildren(reactElement) {
    ...
    const isKnownElement = (reactElement2) => {
      const elementType = reactElement2._currentElement?.type;
  ...
  // playwright/packages/injected/src/roleSelectorEngine.ts
  ...
  // playwright/packages/injected/src/selectorEvaluator.ts
  ...
  // playwright/packages/injected/src/selectorGenerator.ts
  ...
  // playwright/packages/injected/src/vueSelectorEngine.ts
  ...
  function buildComponentsTreeVue3(instance) {
    ...
    function getInstanceName(instance2) {
      ...
      if (instance2.root === instance2)
        return "Root";
      for (const key in instance2.parent?.type?.components) {
        if (instance2.parent?.type.components[key] === instance2.type)
          return saveComponentName(instance2, key);
      }
      for (const key in instance2.appContext?.components) {
  ...
  // playwright/packages/injected/src/xpathSelectorEngine.ts
  var XPathEngine = {
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/locatorUtils.ts
  ...
  // playwright/packages/injected/src/consoleApi.ts
  ...
  // playwright/packages/playwright-core/src/utils/isomorphic/utilityScriptSerializers.ts
...
${value.stack}`;
  ...
  // playwright/packages/injected/src/utilityScript.ts
  ...
  // playwright/packages/injected/src/injectedScript.ts
...
`);
    ...
    markTargetElements(markedElements, callId) {
      ...
      const previous = this._markedElements?.elements || /* @__PURE__ */ new Set();
  ...
  // generated-entry.ts
  window.PlaywrightGenerator = new InjectedScript(
    globalThis,
    {
      isUnderTest: false,
      // Required by interface
      sdkLanguage: "javascript",
      // maps to your "javascript" arg
      testIdAttributeName: "data-testid",
      // maps to your "testId" arg
      stableRafCount: 1,
      // maps to your "1" arg
      browserName: "chromium",
      // maps to your "chromium" arg
      inputFileRoleTextbox: false,
      // Required by interface (default behavior)
      customEngines: []
      // maps to your { engines: [] } arg
    }
  );
})();
